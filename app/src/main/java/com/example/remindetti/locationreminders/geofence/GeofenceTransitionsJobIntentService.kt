package com.example.remindetti.locationreminders.geofence
...
import com.example.remindetti.locationreminders.savereminder.SaveReminderFragment.Companion.ACTION_GEOFENCE_EVENT
import com.example.remindetti.util.sendNotification
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        if (intent.action == ACTION_GEOFENCE_EVENT) {
            ...
            if (geofencingEvent.hasError()) {
                Log.e("GeofenceError", "An error has occurred: ${geofencingEvent.errorCode}")
                return
            }
